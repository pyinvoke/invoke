...
The recommended way to get Invoke is to **install the latest stable release via
...
.. note:: 
    See `this blog post <http://bitprophet.org/blog/2012/MM/DD/slug>`_ for
    background on our decision to vendorize dependencies.
